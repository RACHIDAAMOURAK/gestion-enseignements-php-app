...
// Récupérer les infos du vacataire
$stmt = $pdo->prepare("
    SELECT 
        u.id,
        u.nom_utilisateur,
...
<head>
    ...
    <title>Mon Profil - Vacataire</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-control:disabled { opacity: 0.8; cursor: not-allowed; background-color: rgba(27, 36, 56, 0.3); }
        hr { background-color: var(--border-color); opacity: 0.5; }
        h5 { color: var(--accent-color); font-weight: 600; font-size: 1.15rem; margin-bottom: 1.25rem; display: flex; align-items: center; }
        h5 i { margin-right: 0.5rem; }
    </style>
</head>
<body>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <div class="menu-items">
            ...
            <div class="menu-items-bottom">
                <a href="profil.php" class="menu-item active" data-section="profile">
                                ...
                                <form method="post" action="">
                                    <div class="row mb-4">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            ...
                                            <input type="text" class="form-control" id="nom" value="<?= htmlspecialchars($vacataire['nom']) ?>" disabled>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="prenom" class="form-label">Prénom</label>
                                            <input type="text" class="form-control" id="prenom" value="<?= htmlspecialchars($vacataire['prenom']) ?>" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            ...
                                            <input type="email" class="form-control" id="email" value="<?= htmlspecialchars($vacataire['email']) ?>" disabled>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="specialite" class="form-label">Spécialité</label>
                                            <input type="text" class="form-control" id="specialite" value="<?= htmlspecialchars($vacataire['specialite_nom'] ?? '') ?>" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            ...
                                            <input type="text" class="form-control" id="departement" value="<?= htmlspecialchars($vacataire['departement_nom'] ?? '') ?>" disabled>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="date_inscription" class="form-label">Date d'inscription</label>
                                            <input type="text" class="form-control" id="date_inscription" value="<?= htmlspecialchars(date('d/m/Y', strtotime($vacataire['date_inscription']))) ?>" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="role" value="<?= htmlspecialchars(ucfirst($vacataire['role'])) ?>" disabled>
                                        </div>
                                    </div>
